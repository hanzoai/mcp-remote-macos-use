...
[![Docker Pulls](https://img.shields.io/docker/pulls/hanzoai/mcp-remote-macos)](https://hub.docker.com/r/hanzoai/mcp-remote-macos)
  ...
  "mcpServers": {
    "remote-macos": {
      ...
      "args": [
        ...
        "--rm",
        "hanzoai/mcp-remote-macos:latest"
      ]
    }
  }
}
...
git clone https://github.com/hanzoai/mcp-remote-macos.git
cd mcp-remote-macos
```
...
docker build -t mcp-remote-macos .
```
...
2. **Build and push the image for multiple platforms**:
   ```bash
   docker buildx build --platform linux/amd64,linux/arm64 -t hanzoai/mcp-remote-macos:latest --push .
   ```

3. **Verify the image is available for the specified platforms**:
   ```bash
   docker buildx imagetools inspect hanzoai/mcp-remote-macos:latest
   ```
